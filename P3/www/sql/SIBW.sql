...
insert into actividades(nombre, descripcion, imagen1, imagen2, imagen3, precio, fecha, enlace) values('Senderismo en el Monte Rainier', 
                    ...
                    'images/actividades/senderismo.jpg',
                    'images/actividades/senderismo2.jpg',
                    'images/actividades/senderismo3.jpeg', 
                    '100$', 
                    'Todo el año',
                    'actividad.php?id=1');

insert into actividades(nombre, descripcion, imagen1, imagen2, imagen3, precio, fecha, enlace) values('Escalada en Leavenworth',
                    ...
                    'images/actividades/escalada.jpg',
                    'images/actividades/escalada2.jpg',
                    'images/actividades/escalada3.jpg', 
                    '150$', 
                    'Primavera y verano',
                    'actividad.php?id=2');

insert into actividades(nombre, descripcion, imagen1, imagen2, imagen3, precio, fecha, enlace) values('Observatorio Goldendale',
                    ...
                    'images/actividades/observatorio.jpg',
                    'images/actividades/observatorio2.png',
                    'images/actividades/observatorio3.jpeg', 
                    '50$', 
                    'Todo el año', 
                    'actividad.php?id=3');

insert into actividades(nombre, descripcion, imagen1, imagen2, imagen3, precio, fecha, enlace) values('Kayak en el lago Diablo',
                    ...
                    'images/actividades/kayak.jpeg',
                    'images/actividades/kayak2.jpg',
                    'images/actividades/kayak3.jpg', 
                    '75$', 
                    'Primavera y verano',
                    'actividad.php?id=4');

insert into actividades(nombre, descripcion, imagen1, imagen2, imagen3, precio, fecha, enlace) values('Esquí en Crystal Mountain',
                    ...
                    'images/actividades/esqui.jpg',
                    'images/actividades/esqui2.jpg',
                    'images/actividades/esqui3.jpg', 
                    '120$', 
                    'Invierno',
                    'actividad.php?id=5');

insert into actividades(nombre, descripcion, imagen1, imagen2, imagen3, precio, fecha, enlace) values('Rafting en el río Wenatchee',
                    ...
                    'images/actividades/rafting.jpg',
                    'images/actividades/rafting2.jpg',
                    'images/actividades/rafting3.jpeg', 
                    '90$', 
                    'Primavera y verano',
                    'actividad.php?id=6');

insert into actividades(nombre, descripcion, imagen1, imagen2, imagen3, precio, fecha, enlace) values('Excursión al glaciar Coleman',
                    ...
                    'images/actividades/glaciar.jpg',
                    'images/actividades/glaciar2.jpg',
                    'images/actividades/glaciar3.jpg',
                    '200$',
                    'Primavera y verano',
                    'actividad.php?id=7');

insert into actividades(nombre, descripcion, imagen1, imagen2, imagen3, precio, fecha, enlace) values('Observación en North Cascades',
                    ...
                    'images/actividades/observacion.jpg',
                    'images/actividades/observacion2.jpg',
                    'images/actividades/observacion3.jpg',
                    '75$',
                    'Todo el año',
                    'actividad.php?id=8');

insert into actividades(nombre, descripcion, imagen1, imagen2, imagen3, precio, fecha, enlace) values('Pesca en el río Skagit',
                    ...
                    'images/actividades/pesca.jpg',
                    'images/actividades/pesca2.png',
                    'images/actividades/pesca3.jpg',
                    '50$',
                    'Primavera y verano',
                    'actividad.php?id=9');
